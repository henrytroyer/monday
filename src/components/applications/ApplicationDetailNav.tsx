/**
 * ApplicationDetailNav.tsx — Breeze-style section rail for application detail.
 */
...
interface ApplicationDetailNavProps {
  items: ApplicationDetailNavItem[];
  activeId: SectionId;
  onSelect: (id: SectionId) => void;
}

export default function ApplicationDetailNav({
  items,
  activeId,
  onSelect,
}: ApplicationDetailNavProps) {
  return (
    <nav
